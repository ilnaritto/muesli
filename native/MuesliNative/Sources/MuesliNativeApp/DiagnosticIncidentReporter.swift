...
final class DiagnosticIncidentReporter {
    ...
    // nonisolated so it can serve as the default value for the @MainActor
    // TelemetrySink parameter under Swift 6.0.3 (default args evaluate in a
    // nonisolated context); TelemetryDeck.signal is safe off the main actor.
    private nonisolated static func sendTelemetry(_ incident: DiagnosticIncident) {
