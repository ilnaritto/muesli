...
### 🤖 AI-чат по встрече &nbsp;·&nbsp; <sub>дизайн-прототип</sub>

Спроси о звонке своими словами — «расскажи подробнее», «какие были решения», «собери задачи» — и получи ответ по материалам встречи. Интерфейс готов; подключение к движку в работе (см. [Статус](#статус)).
...
**🚧 В процессе**
- **AI-чат по встрече** — интерфейс готов, подключение к движку в работе
...
[MIT](LICENSE) — как и оригинал. Свободно и открыто.
